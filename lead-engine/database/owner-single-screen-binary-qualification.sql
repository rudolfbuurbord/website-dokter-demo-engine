-- Owner-approved qualification policy, 2026-09-21.
-- ## LOCKED — één websitecheck, binaire eindselectie en Dusink-grens — 2026-09-21
-- Besluit-id: owner-single-screen-binary-v2. Expliciet goedgekeurd door Rudolf in deze chat; gaat vóór oudere eisen.
-- - Beoordeel bedrijfsidentiteit, aangeboden schilderdiensten, contactgegevens en visuele geschiktheid in dezelfde bestaande gerenderde website/screenshotronde. Geen afzonderlijke activiteitszoektocht, verplichte recente review/post of registercontrole voor een presenteerbaar bedrijf zonder zichtbaar sluitingssignaal. Dit is een kwalificatie-inferentie op websitepresentatie, geen geverifieerde handelsregisterstatus.
-- - Websiteactiviteit mag basis WEBSITE_BUSINESS_PRESENTATION gebruiken met services_present=true, contact_consistent=true, closure_indication=false en concreet bronbewijs. Identiteit en gevonden brononderbouwd zakelijk e-mailadres blijven nodig; geen adressen raden.
-- - Definitieve menselijke selectie heeft alleen APPROVED of REJECTED. Onvoldoende essentiële informatie na de ene ronde betekent REJECTED voor deze lijst met concrete reden; niet beweren dat het bedrijf gesloten of slecht is. Nog onuitgevoerde taken mogen intern PENDING blijven, maar geen twijfellijst na afronding.
-- - Visuele afwijzing alleen bij duidelijk moderne/verzorgde totaaluitstraling boven eigenaarreferenties. Dusink (dusinkschildersbedrijf.nl) is expliciet ELIGIBLE: verzorgd maar te basic; positief grensvoorbeeld. West & Berg, R. van de Beek, Maxdom, Rensink en Ronald Schilderwerken zijn expliciet negatieve referenties. Nette foto’s, blokken of CTA’s alleen zijn geen afwijzingsgrond.
-- - Afwijzingsgronden: visueel te goed; aantoonbaar gesloten; buiten doelgroep; dubbel; geen gevonden zakelijk e-mailadres; aantoonbare verkeerde bedrijfsidentiteit/onoplosbare koppeling. Andere domeinnaam of handelsnaam alleen is geen afwijsreden.
-- - Cookieblokkade eerst weigeren/sluiten of bestaande bruikbare andere pagina/screenshot gebruiken. Blijft de site onzichtbaar: REJECTED voor deze lijst, reden VISUAL_NOT_ASSESSABLE; geen claim van slechte/kapotte site. Geen betaalde herhaalrondes.
-- - NO_WEBSITE_FOUND en WEBSITE_UNREACHABLE blijven aparte toegestane routes met bedrijf/contactbewijs uit de beschikbare bron; een capturefout is nooit zelfstandig bewijs van een bezoekersdefect.
-- - Goedkeuring geeft geen toestemming tot mailverzending. Deliverability/suppression/campagnevrijgave blijven bij Outreach. Eerste lijstdoel exact 100 unieke goedgekeurde bedrijven; overige goede kandidaten als reserve bewaren.
-- 
