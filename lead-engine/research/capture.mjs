...
export async function capture(url){
 ...
 try{
  ...
  const visit=async(target,label,visual=true)=>{
   ...
   if(!status||status>=400||/captcha|verify you are human|checking your browser|access denied/i.test(data.title+' '+data.text.slice(0,500)))throw new Error('CAPTURE_BLOCKED_OR_HTTP_ERROR');
   if(visual){
